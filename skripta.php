...
$title = isset($_POST['title']) ? mysqli_real_escape_string($dbc, $_POST['title']) : 'Nema naslova';
...
$category = isset($_POST['category']) ? mysqli_real_escape_string($dbc, $_POST['category']) : 'Srednja Europa';
...
if (!$result) {
    die("Greška pri upisu u bazu: " . mysqli_error($dbc));
}
